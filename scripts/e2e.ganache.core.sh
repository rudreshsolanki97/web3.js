# ----------------------------------------------------------------------------------------
# Run trufflesuite/ganache-core using a candidate branch of xdc3 which has been published
...
npm install
npm uninstall --save-dev xdc3
npm install --save-dev xdc3@e2e --registry http://localhost:4873

npm list xdc3
npm list xdc3-utils
npm list xdc3-core
npm list xdc3-core-promievent
