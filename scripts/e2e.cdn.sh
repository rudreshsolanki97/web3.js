...
# --------------------------------------------------------------------
# Prepares a small test site that uses the packages/xdc3/dist/min
# --------------------------------------------------------------------
...
echo "======================================================================"
echo "Preparing test site for xdc3-staging.netlify.app                      "
echo "======================================================================"

cp packages/xdc3/dist/xdc3.min.js scripts/html

cd scripts/html

BUNDLE_SIZE=$(wc -c xdc3.min.js | awk '{print $1}')
